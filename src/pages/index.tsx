  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine: Streamlining Your Dining Experience. Reserve Your Tables, Let Our Team Manage Your Reservations and Menus. A New Era of Restaurant Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine: Streamlining Your Dining Experience. Reserve Your Tables, Let Our Team Manage Your Reservations and Menus. A New Era of Restaurant Management.`}
            </Text>
            <Box
